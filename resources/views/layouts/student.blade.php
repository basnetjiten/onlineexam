                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        ...
                                        <form id="logout-form4" action="{{ route('Studentlogout') }}" method="POST"
                                              style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </li>
                                ...
                                <li class="user-profile header-notification">
                                    ...
                                    <ul class="show-notification profile-notification">
                                        ...
                                        <li>
                                            ...
                                            <form id="logout-form5" action="/Studentlogout" method="POST"
                                                  style="display: none;">
                                                {{ csrf_field() }}
                                            </form>
                                        </li>
                                    ...
                                    <div class="main-menu-content">
                                        <ul>
                                            <li class="more-details">
                                                ...
                                                <form id="logout-form3" action="/Studentlogout" method="POST"
                                                      style="display: none;">
                                                    {{ csrf_field() }}
                                                </form>
                                            </li>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="pcoded-hasmenu">
                                       ...
                                       {{-- <a href="/admit_card">
                                            <span class="pcoded-micon"><i class="ti-layout-grid2-alt "></i></span>
                                            <span class="pcoded-mtext"
                                                  data-i18n="nav.basic-components.main">Admit Card</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>--}}
                                    ...
                                    <li class="pcoded">
                                        <a href="/result">
                                            <span class="pcoded-micon"><i
                                                        class="ti-layout-grid2-alt"></i><b>R</b></span>
