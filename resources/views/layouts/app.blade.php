    ...
    <script>
        var PreviewA = {
            ...
            SwapBuffersA: function () {
                ...
                bufferA.style.visibility = "hidden";
                bufferA.style.position = "absolute";
                previewA.style.position = "";
                previewA.style.visibility = "";
            },
    ...
    <script>
        var PreviewB = {
            ...
            SwapBuffersB: function () {
                ...
                this.previewB = previewB;
                bufferB.style.visibility = "hidden";
                bufferB.style.position = "absolute";
                previewB.style.position = "";
                previewB.style.visibility = "";
            },
    ...
    <script>
        var PreviewC = {
            ...
            SwapBuffersC: function () {
                ...
                bufferC.style.visibility = "hidden";
                bufferC.style.position = "absolute";
                previewC.style.position = "";
                previewC.style.visibility = "";
            },
    ...
    <script>
        var PreviewD = {
            ...
            SwapBuffersD: function () {
                ...
                bufferD.style.visibility = "hidden";
                bufferD.style.position = "absolute";
                previewD.style.position = "";
                previewD.style.visibility = "";
            },
                                ...
                                <li class="user-profile header-notification">
                                    ...
                                    <ul class="show-notification profile-notification">
                                        ...
                                        <li>
                                            ...
                                            <form id="logout-form1" action="/logout" method="POST"
                                                  style="display: none;">
                                                {{ csrf_field() }}
                                            </form>
                                        </li>
                                ...
                                <div class="">
                                    <div class="main-menu-header">
                                        ...
                                        <div class="user-details">
                                            <span>{{ Auth::user()->name }} </span>
                                            <span id="more-details">{{ Auth::user()->institution_name }} <i
                                    ...
                                    <div class="main-menu-content">
                                        <ul>
                                            <li class="more-details">
                                                ...
                                                <form id="logout-form2" action="/logout" method="POST"
                                                      style="display: none;">
                                                    {{ csrf_field() }}
                                                </form>
                                            </li>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="pcoded-hasmenu">
                                        <a href="/StudentResult">
                                            <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                            <span class="pcoded-mtext"
                                                  data-i18n="nav.basic-components.main">Results</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms"> Add New Exam &amp;
                                    Student
                                </div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li>
                                    ...
                                    <li>
                                        <a href="/Exams">
                                            <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                            <span class="pcoded-mtext"
                                                  data-i18n="nav.form-components.main">Add New Exam</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
        ...
        $("#addexam").click(function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'examattempt': $('input[name=examattempt]').val(),
                },
