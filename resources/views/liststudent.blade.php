                                                    ...
                                                    @foreach ($students as $value)
                                                        <tr class="student{{$value->id}}">
                                                            ...
                                                            <td  class="separator">
                                                                ...
                                                                @if ($value->allow_exam_review)
                                                                <a onclick="Exam_reviewer( '{{ $value->id }}' )" href="#" class="detete-modal btn btn-success btn-sm" data-id="{{ $value->id }}">
                                                                    <i class="glyphicon glyphicon-check"></i>
                                                                </a>
                                                                    @else
                                                                    <a onclick="Exam_reviewer({{ $value->id}})" href="#" class="detete-modal btn btn-light btn-sm" data-id="{{ $value->id }}">
