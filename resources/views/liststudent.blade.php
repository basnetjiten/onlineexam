                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-danger hidden">Expired At</th>
                                                ...
                                                @foreach ($students as $value)
                                                    <tr class="student{{$value->id}}">
                                                        ...
                                                        <td class="text-danger hidden">{{ "e" }} </td>
                                                        <td class="text-center">

                                                            <label style="margin-left: 80px;padding-left: 50px"> <input type="checkbox"
                                                                                                      id="check"
                                                                                                      class="published"
                                                                                                      data-id="{{$value->id}}"
                                                                                                      @if ($value->allow_exam_review)checked
                                                                        @endif>
                                                        ...
                                                        <td>
                                                            <a style="width: 30px;height:30px;margin-bottom: 80px;margin-right: 10px;"
                                                               onclick="viewdetail( '{{ $value->name }}','{{ $value->student_id }}', '{{Auth::user()->id}}','{{ $value->created_at }}')"
                                                               href="#" class="show-modal btn btn-info btn-sm"
                                                               data-id="{{ $value->id }}" data-name="{{ $value->name }}"
                                                               data-student_id="{{ $value->student_id }}">
                                                                <i class="icofont icofont-eye-alt"></i>
                                                            </a>
                                                            <a style="width: 30px;height:30px;margin-bottom: 80px;margin-right: 10px;"
                                                               onclick="Editdetail( '{{ $value->id }}','{{ $value->name }}','{{ $value->student_id }}' )"
                                                               href="#" class="edit-modal btn btn-warning btn-sm"
                                                               data-id="{{ $value->id }}" data-name="{{ $value->name }}"
                                                               data-student_id="{{ $value->student_id }}">
                                                                <i class="glyphicon glyphicon-pencil"></i>
                                                            </a>
                                                            <a style="width: 30px;height:30px;margin-bottom: 80px;"
                                                               onclick="Delete_user( '{{ $value->id }}','{{ $value->name }}','{{ $value->student_id }}' )"
                                                               href="#" class="detete-modal btn btn-danger btn-sm"
                                                               data-id="{{ $value->id }}" data-name="{{ $value->name }}"
                                                               data-student_id="{{ $value->student_id }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <input type="hidden" disabled class="form-control" id="admin_id" name="admin_id"
                               value=" {{ Auth::user()->id }}" placeholder="institution Id" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="chzn-select form-control" id="category" name="category"
                        ...
                        <input type="hidden" disabled class="form-control" id="admin_email" name="admin_email"
                               value=" {{ Auth::user()->email }}" placeholder="Institution Email" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <input type="hidden" disabled class="form-control" id="uid" name="uid" placeholder="Field Id"
                               required>

                        <div class="form-group">
                            <label class="control-label col-sm-4" for="student_id">Student Id :</label>
                            <div class="col-sm-8">
                                <input type="text" disabled class="form-control" id="ustudent_id" name="ustudent_id"
                                       placeholder="Enter Student Id" required>
                                <p class="student_id_error text-center alert alert-danger hidden"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="upassword_confirmation" type="password" class="form-control"
                                       name="upassword_confirmation" required>
