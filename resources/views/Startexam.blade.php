                        ...
                        <div class="row question_rearrange">
                            ...
                            @foreach ($subjectquestion as $value)
                                <script>
                                    ...
                                    set_current_subject_state=['{{$value->id}}','{{$value->examcode}}','{{$userId}}','{{$value->subject_type}}','{{$value->subject_id}}','{{$value->subject_level}}','{{$value->pass_mark}}'];
                                    //store current subject and question in array
                                            ...
                                            <div id="ques_block{{$value->id}}" class="col-sm-8 hideme hidden">
                                                ...
                                                <div class="card">
                                                    <div class="alert alert-light text-justify col-sm-12">
                                                        ...
                                                        <h4 class="modal-title text-dark"><b> <span
                                                                        class="setqno">{{$no++}}</span> :</b > {{$value->question}}</h4>
                                                        @if ($value->image != NULL)
                                                            {{--<div>
                                                    ...
                                                    <div class="card-block ">
                                                        ...
                                                        <form action="#">
                                                            <p class="col-sm-12">
                                                                <input type="radio" id="optionA{{$value->id}}"
                                                                       name="option{{$value->id}}" value="A">
                                                                <label for="optionA{{$value->id}}">{!!$value->option_A!!}</label>
                                                                @if ($value->image_A != NULL)
                                                                    <div>

                                                                        <img class="img-responsive" src="{{URL::to('/')}}/images/{!!$value->image_A!!}" width="150px" height="40px" alt=""/>

                                                                    </div>
                                                                @endif
                                                            </p>
                                                            <p class="col-sm-12">
                                                                <input type="radio" id="optionB{{$value->id}}"
                                                                       name="option{{$value->id}}" value="B">
                                                                <label for="optionB{{$value->id}}">{!!$value->option_B!!}</label>
                                                                @if ($value->image_B != NULL)
                                                                    <div>
                                                                        <img class="img-responsive" src="{{URL::to('/')}}/images/{!!$value->image_B!!}" width="150px" height="40px" alt=""/>

                                                                    </div>
                                                                @endif
                                                            </p>
                                                            <p class="col-sm-12">
                                                                <input type="radio" id="optionC{{$value->id}}"
                                                                       name="option{{$value->id}}" value="C">
                                                                <label for="optionC{{$value->id}}">{!!$value->option_C!!}</label>
                                                                @if ($value->image_C != NULL)
                                                                    <div>
                                                                        <img class="img-responsive" src="{{URL::to('/')}}/images/{!!$value->image_C!!}" width="150px" height="40px" alt=""/>
                                                            ...
                                                            <p class="col-sm-12">
                                                                ...
                                                                @if ($value->image_D != NULL)
                                                                      <div>
                                                                          <img class="img-responsive" src="{{URL::to('/')}}/images/{!!$value->image_D!!}" width="150px" height="40px" alt=""/>

                                                                      </div>
                                                                @endif
                                                            </p>
                                                        </form>
                                                        <input type="hidden" id="correctoption{{$value->id}}"
                                                               value="{{$value->correct_option}}">
                                                        <input type="hidden" id="marks{{$value->id}}"
                                                               value="{{$value->marks}}">
                                                        <input type="hidden" id="negmarks{{$value->id}}"
                                                        ...
                                                        <div class="col-xs-12 text-center" style="margin-bottom:20px;">
                                                            @if ($no > 2)
                                                                <button type="button"
                                                                        ...
                                                                        id="previous" style="background: #298c38" class="btn btn-outline-secondary text-white select-button">
                                                                    Previous
                                                                </button>
                                                            @endif
                                                            <button type="button"
                                                                    onclick="Save('{{$no-1}}',{{$subjectquestion}})"
                                                                    style="background: #298c38"  class="btn btn-outline-secondary text-white select-button">Save &
                                                                Next
                                                            </button>
                                                            <button type="button"
                                                                    onclick="Reminder('{{$no-1}}',{{$subjectquestion}})"
                                                                    style="background: #298c38"   class="btn btn-outline-secondary text-white select-button">Reminder
                                                            </button>
                                                            @if ($no <= sizeof($subjectquestion))
                                                                <button type="button"
                                                                        onclick="Skip('{{$no-1}}',{{$subjectquestion}})"
                                                                        style="background: rgb(251, 101, 96)"   class="btn btn-outline-secondary text-white select-button">
                                                                    Skip
                                                                </button>
                                                            ...
                                                            <button id="examfinished" type="button"
                                                                    ...
                                                                    style="background: #298c38; background-color: #0495c9;"    class="Finshexam btn btn-outline-secondary text-white select-button hidden"
                                                            >Finish
                                                            </button>
