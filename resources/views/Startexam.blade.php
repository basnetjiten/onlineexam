                                                        ...
                                                        <div class="row">
                                                                <div class="col-xs-12 text-center" style="margin-bottom:20px;">
                                                                   ...
                                                                   @if ($no <= sizeof($question))
                                                                    <button type="button"  onclick="Skip('{{$no-1}}',{{$question}})"
                                                                            class="btn btn-outline-danger select-button">Skip</button>


                                                                    @endif
                                                                    <button id="examfinished" type="button" onclick="finish('{{$id}}','{{$userId}}')" class="Finshexam btn btn-outline-primary select-button hidden"
                                                                            >Finish</button>
...
// Add AddUserResponse
        ...
        function finish($examCode,$studentId){
            $("#examover").removeClass('hidden');
            $("#show_exam").addClass('hidden');



          //  examcode = $(this).data.id;
